        ...
        <div class="row">
            ...
            <div class="col-md-3">
                <div class="d-flex align-items-center mb-3">
                    <img src="{{ $image->user->profileImageUrl() }}" width="60" alt="Author"
                        class="rounded-circle mr-3">
                    <div class="ms-3">
                        <h5><a href="{{ $image->user->url() }}"
                                class="text-decoration-none">{{ $image->user->name }}</a></h5>
                ...
                <div class="d-flex justify-content-between py-3 border-top border-bottom">
                    ...
                    <div>
                        <button type="button" title="Like mage" class="btn btn-primary">
                            <x-icon src="thumbs-up.svg" alt="" class="align-text-top" width="18"
                                height="18" /> 150
                        </button>
