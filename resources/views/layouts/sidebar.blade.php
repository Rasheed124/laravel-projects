                        ...
                        <div class="lg:hidden lg:sidebar-expanded:block 2xl:block">
                            <ul class="pl-8 mt-1" x-show="open" x-cloak>
                                <li class="mb-1 last:mb-0">
                                    <a class="block transition truncate {{ request()->routeIs('profile.edit') ? 'text-violet-500' : 'text-gray-500/90 dark:text-gray-400 hover:text-gray-700 dark:hover:text-gray-200' }}"
                                ...
                                <li class="mb-1 last:mb-0">
                                    <a class="block transition truncate {{ request()->routeIs('profile.notifications') ? 'text-violet-500' : 'text-gray-500/90 dark:text-gray-400 hover:text-gray-700 dark:hover:text-gray-200' }}"
