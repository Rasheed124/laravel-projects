<x-app-layout title="Edit Post">
    <div class="px-4 sm:px-6 lg:px-8 py-8 w-full max-w-4xl mx-auto">
        <div class="mb-8">
            <h1 class="text-2xl md:text-3xl text-gray-800 dark:text-gray-100 font-bold">Modify Post Draft</h1>
        </div>
            ...
            <form action="{{ route('posts.update', $post->id) }}" method="POST">
                ...
                <div class="space-y-5">
                    <div>
                        ...
                        <input id="title" name="title" class="form-input w-full px-3 py-2 border border-gray-200 dark:border-gray-700 rounded-lg bg-transparent dark:text-white focus:border-violet-500 focus:outline-none" type="text" value="{{ old('title', $post->title) }}" required />
                    ...
                    <div class="flex items-center space-x-2 py-1">
                        <input type="checkbox" id="is_featured" name="is_featured" value="1" {{ old('is_featured', $post->is_featured) ? 'checked' : '' }} class="form-checkbox h-4 w-4 text-violet-500 border-gray-200 dark:border-gray-700 rounded focus:ring-violet-500">
                    ...
                    <div>
                        ...
                        <input id="excerpt" name="excerpt" class="form-input w-full px-3 py-2 border border-gray-200 dark:border-gray-700 rounded-lg bg-transparent dark:text-white focus:border-violet-500 focus:outline-none" type="text" value="{{ old('excerpt', $post->excerpt) }}" />
                    ...
                    <div>
                        ...
                        <textarea id="content" name="content" rows="10" class="form-textarea w-full px-3 py-2 border border-gray-200 dark:border-gray-700 rounded-lg bg-transparent dark:text-white focus:border-violet-500 focus:outline-none" required>{{ old('content', $post->content) }}</textarea>
                ...
                <div class="flex items-center justify-end border-t border-gray-100 dark:border-gray-700/60 pt-5 mt-6 space-x-2">
                    ...
                    <button type="submit" class="px-4 py-2 bg-violet-500 hover:bg-violet-600 text-white font-medium text-sm rounded-lg shadow-sm">Save Changes</button>
                </div>
            </form>
        </div>
    </div>
