            ...
            <div class="row gx-5">
                ...
                <div class="col-md-6">
                    <fieldset>
                        ...
                        <div class="mb-3">
                            <img src="{{ $user->hasCoverImage() ? $user->coverImageUrl() : 'https://via.placeholder.com/600x250&text=Cover Image' }}"
                                class="img-fluid" alt="">
                        </div>
                    </fieldset>
                    <fieldset class="mt-3">
                        ...
                        <div class="mb-3">
                            ...
                            <div class="form-check">
                                ...
                                <input class="form-check-input" type="checkbox"
                                    ...
                                    id="email_notification_new_comment" value="1" @checked(old('options.email_notification.new_comment', data_get($user, 'setting.email_notification.new_comment')) == 1)>
                                <label class="form-check-label" for="email_notification_new_comment">
                            ...
                            <div class="form-check">
                                ...
                                <input class="form-check-input" type="checkbox"
                                    name="options[email_notification][new_image]" id="email_notification_new_image"
                                    value="1" @checked(old('options.email_notification.new_image', data_get($user, 'setting.email_notification.new_image')) == 1)>
                                <label class="form-check-label" for="email_notification_new_image">
